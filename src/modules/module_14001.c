...
static const char *HASH_NAME      = "DES (PT = $salt = 1122334455667788, key = $pass)";
static const u64   KERN_TYPE      = 14001;
...
static const char *ST_HASH        = "c4efa0c11bc72266:1122334455667788";
...
{
  const u32 pw_min = 7; // 56->64 expansion like MS does
...
{
  const u32 pw_max = 7; // 56->64 expansion like MS does
