...
KERNEL_FQ void m14001_mxx (KERN_ATTR_RULES ())
{
  /**
   * base
   */
  ...
  const u32 w0 = (new3 << 24) | (new2 << 16) | (new1 << 8) | (new0);  
  const u32 w1 = (new7 << 24) | (new6 << 16) | (new5 << 8) | (new4);
  ...
  const u32 pw_len = pws[gid].pw_len + 1;
...
KERNEL_FQ void m14001_sxx (KERN_ATTR_RULES ())
{
  /**
   * base
   */
