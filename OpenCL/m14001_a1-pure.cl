...
KERNEL_FQ void m14001_mxx (KERN_ATTR_BASIC ())
{
  /**
   * base
   */
...
//    printf("\nw1: %x\n", w0[1]);
    ...
    u8 byte0 = (w0[0] & 0xff);
    u8 byte1 = ((w0[0] & 0xff00) >> 8);
    u8 byte2 = ((w0[0] & 0xff0000) >> 16);
    u8 byte3 = (w0[0] >> 24);

    u8 byte4 = (w0[1] & 0xff);
    u8 byte5 = ((w0[1] & 0xff00) >> 8);
    u8 byte6 = ((w0[1] & 0xff0000) >> 16);
    u8 byte7 = (w0[1] >> 24);
...
//    const u32 c = (w0[0]);
//    const u32 d = (w0[1]);
    const u32 c = (new3 << 24) | (new2 << 16) | (new1 << 8) | (new0 & 0xff);
    const u32 d = (new7 << 24) | (new6 << 16) | (new5 << 8) | (new4 & 0xff);
...
KERNEL_FQ void m14001_sxx (KERN_ATTR_BASIC ())
{
  /**
   * base
   */
